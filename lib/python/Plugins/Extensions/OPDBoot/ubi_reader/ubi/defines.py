...
EC_HDR_FIELDS = ["magic", "version", "padding", "ec", "vid_hdr_offset", "data_offset", "image_seq", "padding2", "hdr_crc"]
UBI_EC_HDR_SZ = struct.calcsize(EC_HDR_FORMAT)
UBI_VID_HDR_MAGIC = "UBI!"
VID_HDR_FORMAT = ">4sBBBBII4sIIII4sQ12sI"
VID_HDR_FIELDS = ["magic", "version", "vol_type", "copy_flag", "compat", "vol_id", "lnum", "padding", "data_size", "used_ebs", "data_pad", "data_crc", "padding2", "sqnum", "padding3", "hdr_crc"]
UBI_VID_HDR_SZ = struct.calcsize(VID_HDR_FORMAT)
VTBL_REC_FORMAT = ">IIIBBH128sB23sI"
VTBL_REC_FIELDS = ["reserved_pebs", "alignment", "data_pad", "vol_type", "upd_marker", "name_len", "name", "flags", "padding", "crc"]
